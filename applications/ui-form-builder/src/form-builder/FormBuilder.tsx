...
const FormBuilder = () => {
  ...
  //             ? setTabElements(data.tabComponents[0])
  //             : data.dropId === "tabsDroppableId2"
  //             ? setTabElements2(data.tabComponents[1])
  //             : data.dropId === "tabsDroppableId3"
  //             ? setTabElements3(data.tabComponents[2])
  //             : data.dropId === "tabsDroppableId4"
  //             ? setTabElements4(data.tabComponents[3])
  //             : setTabElements5(data.tabComponents[4])
  //         )
